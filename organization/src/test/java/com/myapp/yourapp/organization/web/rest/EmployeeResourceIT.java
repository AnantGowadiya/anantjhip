package com.myapp.yourapp.organization.web.rest;

import com.myapp.yourapp.organization.OrganizationApp;
import com.myapp.yourapp.organization.domain.Employee;
import com.myapp.yourapp.organization.domain.Department;
import com.myapp.yourapp.organization.repository.EmployeeRepository;
import com.myapp.yourapp.organization.service.EmployeeService;
import com.myapp.yourapp.organization.web.rest.errors.ExceptionTranslator;
...
import static com.myapp.yourapp.organization.web.rest.TestUtil.createFormattingConversionService;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.myapp.yourapp.organization.domain.enumeration.Gender;
/**
 * Integration tests for the {@link EmployeeResource} REST controller.
 */
@SpringBootTest(classes = OrganizationApp.class)
public class EmployeeResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "|)@{:.t";
    private static final String UPDATED_EMAIL = "a3@I.z";
